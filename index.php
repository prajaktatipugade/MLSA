...
<<<<<<< HEAD
  ...
  <div class="navbar">
    ...
    <div class="center-nav">
      <li><a href="#home-page" class="scroll-link" data-scroll-to="0">Home</a></li>
      <li><a href="#about-page" class="scroll-link" data-scroll-to="800">About</a></li>
      <li><a href="#event-container" class="scroll-link" data-scroll-to="800">Activities</a></li>
      <li><a href="#profile-container" class="scroll-link" data-scroll-to="800">Team</a></li>
      <li><a href="#contact-container" class="scroll-link" data-scroll-to="800">Contact us</a></li>
    </div>
    ...
    <div class="nav-logo2">
      <img src="Image/dyplgias-removebg-preview.png">
    </div>
  </div>
  <div class="home-page" id="home-page">
    <div class="home-page-center">
      ...
      <div class="home-page-right"><img src="Image/mlsa-logo-removebg-preview.png"></div>
    </div>
  </div>
